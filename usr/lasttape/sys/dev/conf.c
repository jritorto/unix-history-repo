...
struct bdevsw	bdevsw[] =
{
	...
	utopen,		utclose,	utstrategy,	utdump, 0,	/*10*/
	nulldev,	nulldev,	idcstrategy,	idcdump, 0,	/*11*/
	nodev,		nodev,		nodev,		nodev,	0,	/*12*/
	0,
};
...
struct cdevsw	cdevsw[] =
{
	...
	dmfopen,	dmfclose,	dmfread,	dmfwrite,	/*25*/
